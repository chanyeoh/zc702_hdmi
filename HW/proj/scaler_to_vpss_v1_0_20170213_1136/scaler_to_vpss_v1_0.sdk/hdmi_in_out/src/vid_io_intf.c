...
// Globals
// *****************************************************
static const Xuint8 fmc_imageon_hdmii_edid_content[256] =
{
...
static fmc_imageon_video_timing_t input_timing_inst;
static fmc_imageon_video_timing_t output_timing_inst;
...
)
{
	...
	p_vid_io_intf_inst->p_input_timing_inst    = &input_timing_inst;
	p_vid_io_intf_inst->p_output_timing_inst   = &output_timing_inst;
	
	// Initialize object data
	p_vid_io_intf_inst->fmc_imageon_is_present = 0;
	p_vid_io_intf_inst->p_input_timing_inst->HActiveVideo  = 1280; // This needs to be non-zero by upper layer drivers
	p_vid_io_intf_inst->p_input_timing_inst->VActiveVideo  = 720;  // This needs to be non-zero by upper layer drivers
	p_vid_io_intf_inst->p_output_timing_inst->HActiveVideo = 1280; // This needs to be non-zero by upper layer drivers
	p_vid_io_intf_inst->p_output_timing_inst->VActiveVideo = 720;  // This needs to be non-zero by upper layer drivers
	...
	if (vid_io_intf_get_fmc_status(p_vid_io_intf_inst))
	{
		...
		detected_input_resolution = vid_io_intf_detect_input_fsize(p_vid_io_intf_inst);
