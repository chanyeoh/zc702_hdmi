...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = control_path_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = control_path_axi_iic_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = video_path_framebuffer_new_axi_vdma_new
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.0
 PARAMETER HW_INSTANCE = video_path_framebuffer_old_axi_vdma_old
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 7.1
 PARAMETER HW_INSTANCE = video_path_hdmi_in_vtd
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 7.1
 PARAMETER HW_INSTANCE = video_path_hdmi_out_vtg
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = video_path_scaler_new_v_proc_ss_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = scaler
 PARAMETER DRIVER_VER = 7.0
 PARAMETER HW_INSTANCE = video_path_scaler_old
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 7.0
 PARAMETER HW_INSTANCE = video_path_tpg_new_tpg_new
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 7.0
 PARAMETER HW_INSTANCE = video_path_tpg_old_tpg_old
END
