...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = hdmi_in_proc_axi_vdma_new
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 7.1
 PARAMETER HW_INSTANCE = hdmi_in_proc_hdmi_in_vtd
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = hdmi_in_proc_v_proc_ss_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 7.1
 PARAMETER HW_INSTANCE = hdmi_out_vtg
END
