...
HD_PWD='C:/hdmi_final/HW/proj/scaler_to_vpss_v1_0/scaler_to_vpss_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scaler_to_vpss.vds -m64 -mode batch -messageDb vivado.pb -notrace -source scaler_to_vpss.tcl
