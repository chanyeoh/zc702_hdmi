...
HD_PWD='C:/hdmi_final/HW/proj/scaler_to_vpss_v1_0/scaler_to_vpss_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scaler_to_vpss.vdi -applog -m64 -messageDb vivado.pb -mode batch -source scaler_to_vpss.tcl -notrace
